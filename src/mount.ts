import {
  ICON_DESIGN_LAYERS_PANEL,
  ICON_LAYER_AUTO_LAYOUT,
  ICON_LAYER_BODY,
  ICON_LAYER_COLLAPSE,
  ICON_LAYER_DISCLOSURE_COLLAPSED,
  ICON_LAYER_DISCLOSURE_EXPANDED,
  ICON_LAYER_EXPAND,
  ICON_LAYER_FRAME,
  ICON_LAYER_IMAGE,
  ICON_LAYER_TEXT,
...
const {
  ...
  changesDelete: CHANGES_HOVER_DELETE_URL,
  changesCopy: CHANGES_HOVER_COPY_URL,
  changesCopySuccess: CHANGES_HOVER_COPY_SUCCESS_URL,
  changesPreviewAfter: CHANGES_HOVER_PREVIEW_AFTER_URL,
  changesPreviewBefore: CHANGES_HOVER_PREVIEW_BEFORE_URL,
...
export function mountElementInspector(options: ElementInspectorOptions = {}): ElementInspectorInstance {
  ...
  const layersCollapseBtn = el('button', 'ei-design-action-btn ei-layers-window-btn ei-layers-window-btn-collapse') as HTMLButtonElement
  ...
  const layersCloseBtn = el('button', 'ei-design-action-btn ei-layers-window-btn') as HTMLButtonElement
  ...
  const panelMinimizeBtn = el('button', 'ei-design-action-btn ei-panel-minimize') as HTMLButtonElement
  const panelActionDivider = el('div', 'ei-panel-action-divider')
  const changesCloseBtn = el('button', 'ei-design-action-btn ei-changes-close') as HTMLButtonElement
  copyBtn.type = 'button'
