    ...
    <div class="wb-gallery-stack">
      ...
      <div>
        ...
        <div class="ei-capture-menu wb-mini-menu">
          ...
          <button class="ei-capture-menu-item ${context.previewClass}" data-size="lg"><span class="ei-capture-menu-icon">⊘</span><span class="ei-capture-menu-label">忽略本次操作</span></button>
        </div>
      </div>
    </div>
  `
